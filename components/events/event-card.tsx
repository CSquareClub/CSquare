...
export default function EventCard({
  ...
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-card/70 transition-all duration-500 hover:border-[#0ea5e9]/35 hover:bg-card hover:shadow-[0_0_30px_rgba(14,165,233,0.15)]">
      ...
      <div className="relative h-48 w-full flex-shrink-0 overflow-hidden bg-card">
        ...
        <span className="absolute top-4 right-4 inline-block px-3 py-1 rounded-full text-xs font-semibold bg-[#0ea5e9]/20 text-[#0ea5e9] border border-[#0ea5e9]/30 backdrop-blur-md">
          {category}
        </span>
      </div>
      ...
      <div className="p-6 flex flex-col flex-grow relative z-10 -mt-8">
        ...
        <h3 className="text-xl font-bold mb-3 text-foreground/90 group-hover:text-[#0ea5e9] transition-colors leading-tight">
          {title}
        </h3>
        ...
        <div className="mt-auto flex items-center justify-between border-t border-border pt-4">
          <button className="rounded-lg border border-border bg-card px-4 py-2 text-sm font-semibold text-foreground transition-all duration-300 hover:border-[#0ea5e9] hover:bg-[#0ea5e9] hover:text-white group-hover:shadow-[0_0_15px_rgba(14,165,233,0.3)]">
            Register Now
          </button>
          <ArrowRight size={16} className="text-[#0ea5e9] group-hover:translate-x-1 transition-transform" />
        </div>
      </div>
    </div>
  );
