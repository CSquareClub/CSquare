...
export default function IndustryProjectProposalForm() {
  ...
  if (submitted) {
    return (
      <div className="rounded-2xl border border-primary/20 bg-black/30 p-10 text-center backdrop-blur-xl">
        ...
        <p className="text-foreground/70">Your industry project proposal has been received. We'll review it and get back to you soon.</p>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-2xl border border-primary/15 bg-black/40 p-8 backdrop-blur-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        {/* SECTION 1 */}
        <div>
          <h3 className="mb-4 text-lg font-bold text-primary">SECTION 1 — Faculty/Industry Contact Information</h3>
          <div className="space-y-4">
            <div>
              <label className={labelCls}>Faculty/Contact Name</label>
              <input
                type="text"
                className={inputCls}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className={labelCls}>Department/Company</label>
                <input
                  type="text"
                  className={inputCls}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <option>Research Software</option>
                  <option>Other</option>
                </select>
              </div>
              <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                ...
                placeholder="Describe the business problem or challenge this project addresses."
                required
              />
            </div>
          ...
          <div className="space-y-4">
            <label className="flex items-start gap-3">
              ...
              <span className="text-sm text-foreground/80">
                I confirm that the submitted project aligns with CUSoC program goals and is feasible within the 8-week duration.
              </span>
            </label>
          </div>
        </div>
