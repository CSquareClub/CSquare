...
export default function IndustryMentorApplicationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const submitData = {
        ...
        industriesFocus: formData.industriesFocus.join(', '),
  ...
  return (
    <div className="rounded-2xl border border-primary/15 bg-black/40 p-8 backdrop-blur-xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          <h3 className="mb-4 text-lg font-bold text-primary">Professional Background</h3>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
            ...
            <div>
              <label className={labelCls}>Industries Focus</label>
              <div className="grid grid-cols-2 gap-3">
                {industries.map((industry) => (
                  <label key={industry} className="flex items-center gap-2">
                    <input
                      type="checkbox"
                      checked={formData.industriesFocus.includes(industry)}
                      onChange={() => handleCheckboxGroup('industriesFocus', industry)}
                      className="h-4 w-4"
                    />
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="What do you want to achieve as a mentor? How can you help students grow?"
                required
              />
            </div>

            <div>
              <label className={labelCls}>Mentorship Style (Optional)</label>
              <textarea
                className={inputCls}
                rows={3}
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Have you mentored anyone before? Describe your experience."
              />
            </div>
          </div>
        </div>
