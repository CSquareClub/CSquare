        ...
        <main className="relative z-10 py-24">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="rounded-2xl border border-border bg-card/60 p-8 text-center">
              <h1 className="text-2xl font-bold tracking-tight md:text-3xl">C Square Club</h1>
              <p className="mt-3 text-foreground/65">We're temporarily unable to load live data. Please refresh in a few minutes.</p>
              <div className="mt-6">
                <Link href="/events" className="text-sm font-medium text-primary hover:underline">
                  Browse Events
                </Link>
